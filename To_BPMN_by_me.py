...
def Inicialization():
    ...
    Preparation(TransactionKinds_arr, ElementaryActorRoles_arr, CompositeActorRoles_arr, Connections_arr, FindLoop(Connections_arr, TransactionKinds_arr))
...
def Preparation(TransactionKinds_arr, ElementaryActorRoles_arr, CompositeActorRoles_arr, Connections_arr, LoopConnections):
#####lines
    lanes = []
        ...
        for tr_name in list(range(len(TransactionKinds_arr))):  #transakce
            if Connections_arr[conn].to_id == TransactionKinds_arr[tr_name].id:  # kdyz najdu transakci v connection
                ...
                for line in lanes:
                    ...
                    index += 1
                #TODO UserTask??
                tasks_to_insert = '    <bpmn:task id="Task_' + str(task_num) + '" name="' + TransactionKinds_arr[tr_name].name + '">\n'
