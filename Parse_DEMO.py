...
def print_TransactionKinds(TransactionKinds_arr):
    ...
    for x in range(len(TransactionKinds_arr)):
        ...
        print("  ", TransactionKinds_arr[x].identification, ":", TransactionKinds_arr[x].name, " ", TransactionKinds_arr[x].transactionSort)
        print("  ")
    print("=========================================")
#####################################################
...
def print_TransactionProcessStepKinds(TransactionProcessStepKinds_arr):
    ...
    for x in range(len(TransactionProcessStepKinds_arr)):
        ...
        print("  ", TransactionProcessStepKinds_arr[x].transactionKind, ":", TransactionProcessStepKinds_arr[x].stepKind)
        print("  ")
    print("=========================================")
#####################################################
...
def print_AttributeTypes(AttributeTypes_arr):
    ...
    for x in range(len(AttributeTypes_arr)):
        ...
        print("  ", AttributeTypes_arr[x].name, ":", AttributeTypes_arr[x].typeName, " ", AttributeTypes_arr[x].entityType)
        print("  ")
    print("=========================================")
#####################################################
...
class CActionRuleType:
    def __init__(self, id, name, transactionKind, transactionProcessStepKind, parameters_ar, condition, then_action, else_action):
        self.id = id
        self.name = name
        self.transactionKind = transactionKind
...
for Connection in doc.DEMOmodel.Connections.Connection:
    ...
    if connection_type_name == "InterstrictionATEAR":
        ...
        Connections_arr.append(CConnection(Connection['Id'], Connection['FromCardinality'], Connection['ToCardinality'],
                                           connection_type_name, "FromAggregateTransactionKind", fromAggregateTransactionKind,
                                           "ToElementaryActorRole", toElementaryActorRole))
...
class all_DEMO:
    def __init__(self, TransactionKinds_arr, ElementaryActorRoles_arr, CompositeActorRoles_arr, TransactionProcessStepKinds_arr,
              AttributeTypes_arr, EntityTypes_arr, ActionRuleTypes_arr, Connections_arr):
...
ALL_DEMO = all_DEMO(TransactionKinds_arr, ElementaryActorRoles_arr, CompositeActorRoles_arr, TransactionProcessStepKinds_arr, AttributeTypes_arr, EntityTypes_arr, ActionRuleTypes_arr, Connections_arr)
